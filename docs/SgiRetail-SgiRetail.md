...
- **Partición calculada**: `CALENDAR(DATE(2023,1,1), DATE(2027,12,31))` enriquecida con `ADDCOLUMNS`.
...
- ⚠️ Las banderas `EsHoy/EsPasado/...` usan **`TODAY()`** → la tabla depende de la fecha de refresco.
